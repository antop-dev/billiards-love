...
.대회를 시작할 수 없는 경우
include::{snippets}/contest-start-can-not/http-response.adoc[]
...
.대회를 중지할 수 없는 경우
include::{snippets}/contest-stop-can-not/http-response.adoc[]
...
.이미 종료한 대회인 경우
include::{snippets}/contest-end-already/http-response.adoc[]
